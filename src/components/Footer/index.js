...
import { faComments, faHeart, faEnvelope, faInfo } from '@fortawesome/free-solid-svg-icons';
  ...
  return (
    <footer id="footer">
      <div className="cards-wrapper">
        <FooterCard iconName={faWhatsapp} cardTitle={'0800 123 2222'} cardText={'Segunda a sexta de 8h às 22h'} shortText={"WhatsApp"} className='whats' />
        <div className="footer-card-wrapper">
          ...
          <FooterCard iconName={faInfo} cardTitle={'Central de Ajuda'} cardText={'Encontre todas as pessoas'} shortText={'Ajuda'} className='help'/>
        </div>
      </div>
